...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _config = __webpack_require__(1171);
	...
	var getDownLoad = function getDownLoad() {
	    if (!(0, _util.getUrlParam)('id')) return;
	    _jquery2.default.get(_config.HTTP_URL.MONITOR_TASK_URL, {
	        task_id: (0, _util.getUrlParam)('id')
	    }, function (data) {
	        if (data.code == 1) {
	            fileId = data.info.name_key;
	            downloadFile();
	            clearTimeout(timeCount);
	            (0, _jquery2.default)('div[nt="wait-wrap"]').hide();
	            (0, _jquery2.default)('div[nt="start-wrap"]').show();
	        } else {
	            setTimeCount();
	        }
	    }, 'json');
	...
	var setTimeCount = function setTimeCount() {
	    clearTimeout(timeCount);
	...
	var MouseEvent = function MouseEvent() {
	    (0, _jquery2.default)('div.KY-item-wrap').on('click', 'a.js-btn', function () {
	        downloadFile();
	    });
	};

	var downloadFile = function downloadFile() {
	    window.location.href = '' + _config.HTTP_URL.DOWNLOAD_FILE_URL + fileId + '&zip_task=1';
	};
...
/***/ (function(module, exports) {
	 ...
	 */
	var HTTP_URL = {
	    GET_TYPE_LIST: '/resource/getType',
	    GET_LIST_URL: '/resource/listData',
	    DOWNLOAD_FILE_URL: '/file/download?name_key=',
	    DELETE_RESOURCE_URL: '/resource/del',
	    IMPORT_FILE_URL: '/resource/import',
	    EXPORT_FILE_URL: '/resource/export',
	    MONITOR_TASK_URL: '/resource/monitoringZipTask',
	    GET_PRIV_LIST: '/priv/myPriv'
	};
