...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * common.js
	 */
	var $ = window.$ = __webpack_require__(842);
	...
	var getNavHeaderInfo = function getNavHeaderInfo() {
	    commonRequest({
	        url: $('#___OA_NEW_SITE').val() + '/nav/header',
	...
	var getMsgNumber = function getMsgNumber() {
	    var ___oaKingNetComPageScript = document.createElement("script");
	    ___oaKingNetComPageScript.setAttribute('src', $('#___OA_NEW_SITE').val() + '/nav/info?url=' + encodeURIComponent(window.location.href));
	    document.getElementsByTagName("head")[0].appendChild(___oaKingNetComPageScript);
	};

	var renderFooter = function renderFooter() {
	    var html = '<div class="footer-inner"><p class="copyright-num">Copyright@2017 \u7248\u6743\u6240\u6709 kingnet.com,All Rights Reserved \u6CAAICP\u590710215773\u53F7-1</p><p class="copyright-num">\u672C\u7CFB\u7EDF\u73B0\u4EC5\u652F\u6301Chrome\u548CSafari\u6D4F\u89C8\u5668\uFF0C\u5176\u4ED6\u6D4F\u89C8\u5668\u53EF\u80FD\u4F1A\u51FA\u73B0\u517C\u5BB9\u6027\u95EE\u9898\u3002</p><a href="' + $('#___OA_NEW_SITE').val() + '/versionlog/view" target="_blank" class="copyright-journal">\u7248\u672C\u65E5\u5FD7</a></div>';
	    $('.footer-new').html(html);
	};

	/*获取url里面的参数*/
	var getUrlPar = function getUrlPar(name) {
	...
	/*统计代码*/
	var statisticsFun = function statisticsFun() {
	    commonRequest({
	        url: $('#___OA_NEW_SITE').val() + '/visitor_statis/v1',
	        data: {
	            code: 'hrm',
	            menu_code: getUrlPar('NEW_MENU_ID') ? getUrlPar('NEW_MENU_ID') : 0,
	            url: window.location.pathname
	        }
	    });
	};

	var commonRequest = function commonRequest(_ref) {
	    var url = _ref.url,
	        _ref$data = _ref.data,
	        data = _ref$data === undefined ? {} : _ref$data,
	        successFn = _ref.successFn,
	        errorFn = _ref.errorFn;
